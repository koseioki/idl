  ...
  return (
    <main id="main-content">
      ...
      <p>
        ...
        many forms of oppression like racism, sexism and ageism might be present
        and active at the same time in a person's life.
      </p>
      <p>
      ...
      <p>
        {" "}
        Discrimination can manifest in various forms, each impacting individuals
        and communities in unique ways. Understanding these types of
        discrimination is crucial for creating inclusive designs that cater to
        diverse needs. Here are some common types of discrimination:
      </p>
